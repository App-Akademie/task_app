...
/// Reverse Number
const TaskModel t_3_5_2_1 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 1,
...
/// Prime Checker
const TaskModel t_3_5_2_2 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 2,
...
/// Seconds Formatter
const TaskModel t_3_5_2_3 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 3,
...
/// Vowel Counter
const TaskModel t_3_5_2_4 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 4,
...
/// Palindrome Checker
const TaskModel t_3_5_2_5 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 5,
...
/// Anagram Checker
const TaskModel t_3_5_2_6 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 6,
...
/// PIN Hacker
const TaskModel t_3_5_2_7 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 7,
...
/// Multiply Advanced
const TaskModel t_3_5_2_8 = TaskModel(
  chapter: 3,
  subChapter: 5,
  lesson: 2,
  taskNumber: 8,
...
/// Hello World
const TaskModel t_4_2_3_1 = TaskModel(
    chapter: 4,
    subChapter: 2,
    lesson: 3,
    taskNumber: 1,
...
const TaskModel t_4_2_4_1 = TaskModel(
    chapter: 4,
    subChapter: 2,
    lesson: 4,
    taskNumber: 1,
...
/// Hello Name!
const TaskModel t_4_3_1_1 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 1,
  taskNumber: 1,
...
/// Blue Containers
const TaskModel t_4_3_2_1 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 2,
  taskNumber: 1,
...
/// Text Styles
const TaskModel t_4_3_2_2 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 2,
  taskNumber: 2,
...
/// Box Decoration
const TaskModel t_4_3_2_3 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 2,
  taskNumber: 3,
...
/// Center in Column
const TaskModel t_4_3_3_1 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 3,
  taskNumber: 1,
...
/// Space in Row
const TaskModel t_4_3_3_2 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 3,
  taskNumber: 2,
...
Sorge für einen Abstand von 64 Einheiten zwischen den beiden Texten, ohne dafür einen `Container` zu verwenden.""",
);

/// Colorful Rectangle
const TaskModel t_4_3_3_3 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 3,
  taskNumber: 3,
...
/// Show Name Button
const TaskModel t_4_3_4_1 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 4,
  taskNumber: 1,
...
const TaskModel t_4_3_4_2 = TaskModel(
  chapter: 4,
  subChapter: 3,
  lesson: 4,
  taskNumber: 2,
...
Der Name soll also beliebig oft angezeigt und versteckt werden können.""",
);

/// Shopping List
const TaskModel t_4_4_1_1 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 1,
  taskNumber: 1,
...
/// Image from Network
const TaskModel t_4_4_2_1 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 1,
...
const TaskModel t_4_4_2_2 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 2,
...
Teste anschließend, ob das Bild auch offline angezeigt wird.""",
);

/// Progress Indicator
const TaskModel t_4_4_2_3 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 3,
...
Zeige während des Ladevorgangs einen `CircularProgressIndicator`. Dabei soll der Progress Indicator den aktuellen Fortschritt anzeigen.""",
);

/// Error Image
const TaskModel t_4_4_2_4 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 4,
  ...
  taskText:
      """Nutze ein `CachedNetworkImage` Widget, um ein Bild aus dem Internet anzuzeigen.
Zeige bei einem Fehler ein alternatives Bild, einen `Text` oder ein `Icon` an.""",
);

/// Shimmer Placeholder
const TaskModel t_4_4_2_5 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 5,
  ...
  taskText:
      """Nutze ein `CachedNetworkImage` Widget, um ein Bild aus dem Internet anzuzeigen.
Zeige während des Ladevorgangs einen `Shimmer Effect` an.""",
);

/// Thumbnail Image
const TaskModel t_4_4_2_6 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 6,
  ...
  taskText:
      """Nutze ein `CachedNetworkImage` Widget, um ein Bild aus dem Internet anzuzeigen.
Zeige während des Ladevorgangs ein `Thumbnail` an.""",
);

/// Camera & Gallery
const TaskModel t_4_4_2_7 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 7,
...
/// Multiple Images
const TaskModel t_4_4_2_8 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 2,
  taskNumber: 8,
...
const TaskModel t_5_1_1_1 = TaskModel(
  ...
  taskText:
      """Rekonstruiere den Screen aus der Aufgabe im Task Sheet und integriere die von dir identifizierten Einflüsse auf das Aussehen einer App.
      
      **Hinweis: Du brauchst kein Scaffold-Widget, da die Task App selbst bereits ein Scaffold mit AppBar bereitstellt.**""",
...
const TaskModel t_5_1_1_2 = TaskModel(
  ...
  taskText:
      """Rekonstruiere den Screen mit dem Lama aus aus der Aufgabe im Task Sheet`.
...
Verwende diese Konstanten dann in deinem Code, um Code-Duplikate zu vermeiden.""",
  taskImagePath: Assets.taskAsset5112,
);

/// Very own Material Button
const TaskModel t_4_4_4_1 = TaskModel(
  chapter: 4,
  subChapter: 4,
  lesson: 4,
  taskNumber: 1,
...
Erstelle dazu ein Widget namens `CustomMaterialButton` innerhalb deiner Solution Datei.
Achte vor allem auf die abgerundeten Ecken, den Schatten sowie die Interaktivität.

Bonus: Stelle den `Ripple`-Effekt des Buttons bei Berührung nach.

**Hinweis: Benutze die Widgets `Container`, `Text`, `GestureDetector`, `InkWell`, `BoxDecoration`, `TextStyle`, …**""",
);

/// Google Fonts
const TaskModel t_4_6_5_1 = TaskModel(
  chapter: 4,
  subChapter: 6,
  lesson: 5,
  taskNumber: 1,
...
/// Fold / Unfold Text
const TaskModel t_4_6_5_2 = TaskModel(
  chapter: 4,
  subChapter: 6,
  lesson: 5,
  taskNumber: 2,
...
Integriere die Funktionalität, dass der Text sich bei einem Klick darauf ausklappt.""",
);

/// Simple Image Asset
const TaskModel t_4_6_3_1 = TaskModel(
  chapter: 4,
  subChapter: 6,
  lesson: 3,
  taskNumber: 1,
...
Erstelle im Anschluss ein Widget, um das Bild anzuzeigen.""",
);

/// Roll the Dice! (FutureBuilder)
const TaskModel t_5_2_3_1 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 3,
  taskNumber: 1,
...
/// Async Progress Bar
const TaskModel t_5_2_4_2 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 4,
  taskNumber: 2,
...
/// Try Catch
const TaskModel t_5_2_4_3 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 4,
  taskNumber: 3,
...
**Hinweis: Du kannst einen Fehler z.B. mit `throw Exception('[dein Exception-Name]')` erzeugen.**""",
);

/// Index Exception
const TaskModel t_5_2_4_4 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 4,
  taskNumber: 4,
...
/// Custom Exception
const TaskModel t_5_2_4_5 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 4,
  taskNumber: 5,
...
/// Roll the Dice!
const TaskModel t_5_2_4_6 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 4,
  taskNumber: 6,
...
const TaskModel t_5_2_4_7 = TaskModel(
  chapter: 5,
  subChapter: 2,
  lesson: 4,
  taskNumber: 7,
